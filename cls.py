...
def parse_args():
    parser=argparse.ArgumentParser(description='cls训练')

    parser.add_argument('--model_path', type=str,help='微调模型的路径')
    parser.add_argument('--max_length', type=int,help='最大长度')
...
def main():
    ...
    ## 加载训练数据
    train_ds=load_dataset('json',data_files='data/train_text_labels.json',split='train')
